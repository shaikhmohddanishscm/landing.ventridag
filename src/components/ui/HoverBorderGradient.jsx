...
const movingMap = {
  TOP: "radial-gradient(20.7% 50% at 50% 0%, #ff0040 0%, rgba(255, 0, 64, 0) 100%)",
  LEFT: "radial-gradient(16.6% 43.1% at 0% 50%, #ff0040 0%, rgba(255, 0, 64, 0) 100%)",
  BOTTOM:
    "radial-gradient(20.7% 50% at 50% 100%, #ff0040 0%, rgba(255, 0, 64, 0) 100%)",
  RIGHT:
    "radial-gradient(16.2% 41.2% at 100% 50%, #ff0040 0%, rgba(255, 0, 64, 0) 100%)",
}
