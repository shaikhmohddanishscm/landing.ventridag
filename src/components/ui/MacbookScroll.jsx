...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[140vh] flex flex-col items-center py-10 md:py-20 lg:py-32 justify-center flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50"
    >
      <motion.div
        style={{
...
const IconTable = ({ className }) => <div className={className}>⊞</div>
const IconSearch = ({ className }) => <div className={className}>🔍</div>
const IconMicrophone = ({ className }) => <div className={className}>🎤</div>
const IconMoon = ({ className }) => <div className={className}>🌙</div>
const IconPlayerSkipBack = ({ className }) => <div className={className}>⏮</div>
const IconPlayerPlay = ({ className }) => <div className={className}>▶</div>
const IconPlayerSkipForward = ({ className }) => <div className={className}>⏭</div>
const IconVolume = ({ className }) => <div className={className}>🔇</div>
const IconVolume2 = ({ className }) => <div className={className}>🔉</div>
const IconVolume3 = ({ className }) => <div className={className}>🔊</div>
const IconWorld = ({ className }) => <div className={className}>🌐</div>
const IconCommand = ({ className }) => <div className={className}>⌘</div>
const IconChevronUp = ({ className }) => <div className={className}>^</div>
const IconCaretUpFilled = ({ className }) => <div className={className}>▲</div>
const IconCaretDownFilled = ({ className }) => <div className={className}>▼</div>
const IconCaretLeftFilled = ({ className }) => <div className={className}>◄</div>
const IconCaretRightFilled = ({ className }) => <div className={className}>►</div>
